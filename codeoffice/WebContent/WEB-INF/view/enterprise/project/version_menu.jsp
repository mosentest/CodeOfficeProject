...
<div class="leftmenu">
	<ul class="vertical-tab">
		...
		<li class="tab ${param.menu eq 'releasesummary' ? 'active' : ''}"><a href="enterprise/pro_${project.code}/v_${version.code}/release"><spring:message code="version.release_case_summary"/></a></li>
		<li class="tab ${param.menu eq 'relatedsummary' ? 'active' : ''}"><a href="enterprise/pro_${project.code}/v_${version.code}/related"><spring:message code="version.related_case_summary"/></a></li>
