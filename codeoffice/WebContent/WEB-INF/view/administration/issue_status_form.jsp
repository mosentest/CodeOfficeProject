		...
		<div class="panel-content">
			<div class="panel-element">
				...
				<div class="panel-element-content">
					<form:form action="administration/status/edit?status=${issueStatus.name}" modelAttribute="issueStatus" method="POST">
					<table class="minor-form-table">
						...
						<tr>
							...
							<td class="minor-form-input-col imglink">
								...
								<span class="color-info placeholder" style="background-color: #${issueStatus.color};" id="color-info" ></span>
