...
<security:authorize access="isAuthenticated()">
	...
	<li class="tab ${param.menu eq 'globaladvanced' ? 'active' : ''}"><a class="link" href="administration/globalAdvanced.html"><spring:message code="administration.system.advancedGlobalSettings"/></a></li>
