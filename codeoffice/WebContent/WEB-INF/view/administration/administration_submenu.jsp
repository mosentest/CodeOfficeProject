...
<div class="sub-menu-link"><a class="link full-link ${param.menu eq 'system' ? 'active' : ''}" href="administration/global.html"><spring:message code="administration.system"/></a></div>
