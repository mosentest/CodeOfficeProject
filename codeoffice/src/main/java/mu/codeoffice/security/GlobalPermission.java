...
public enum GlobalPermission implements Permission {
	...
	SYSTEM_ADMIN("codeoffice.permission.global.system_admin", "ROLE_GLOBAL_SYSTEM_ADMIN", 32, -1),
	ADMIN("codeoffice.permission.global.admin", "ROLE_GLOBAL_ADMIN", 16, 4015),
	PROJECT_ADMIN("codeoffice.permission.global.project_admin", "ROLE_GLOBAL_PROJECT_ADMIN", 8, 3978),
	SHARED_OBJECT("codeoffice.permission.global.shared_object", "ROLE_GLOBAL_SHARED_OBJECT", 4, 0),
	BROWSE_USER("codeoffice.permission.global.browse_user", "ROLE_GLOBAL_BROWSE_USER", 2, 256),
	USER("codeoffice.permission.global.user", "ROLE_GLOBAL_USER", 1, 0);
