...
public enum ProjectPermission implements Permission {
	...
	CASE("case_view", 1, 1), CASE_MANAGE("case_manage", 2, 21), VERSION_COMPONENT("version_component_view", 4, 23), VERSION_COMPONENT_MANAGE("version_component_manage", 8, 31), 
	PROJECT("project_view", 16, 21), PROJECT_MANAGE("project_manage", 32, 63);
